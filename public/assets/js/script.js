                    ...
                    .then(function({enemies}){
                        ...
                        enemyMokepones = enemies.map(function(enemy) {
                            ...
                            if (enemy.mokepon != undefined) {
                                ...
                                switch (mokeponName) {
                                    case 'Hipodoge':
                                        enemyMokepon = new Mokepon('Hipodoge', 'assets/img/webp/mokepon_hipodoge.webp', 5, 'assets/img/webp/hipodoge.webp', enemy.id)                                        
                                        break;
                                    case 'Capipepo':
                                        enemyMokepon = new Mokepon('Capipepo', 'assets/img/webp/mokepon_capipepo.webp', 5, 'assets/img/webp/capipepo.webp', enemy.id)
                                        break;
                                    case 'Ratigueya':
                                        enemyMokepon = new Mokepon('Ratigueya', 'assets/img/webp/mokepon_ratigueya.webp', 5, 'assets/img/webp/ratigueya.webp', enemy.id)
                                        break;
                                    default:
                                        break;
                                }
